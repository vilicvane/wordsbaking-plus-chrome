var langs = {
    "en-US": {
        ...
        wordsbookCloseToLimit: 'Your words in wordsbook is very close to the limit.\nIf it exceeds, the earliest word added would be removed from wordsbook.\nHowever, it will still be in the list of the words you\'ve studied.',
        wordsbookReachesLimit: 'Your words in wordsbook has reached the limit.\nIf it exceeds, the earliest word added would be removed from wordsbook.\nHowever, it will still be in the list of the words you\'ve studied.',
        wordsbookExceedsLimit: 'Your words in wordsbook has exceeded the limit, and the earliest word added would be removed from wordsbook.\nHowever, it will still be in the list of the words you\'ve studied.',
        setupAccount: 'wordsbook',
        bingMore: "Bing more",
        poweredBy: 'Powered by Bing',
        synonyms: "Synonyms",
        ...
        options: {
            ...
            popupCtrlKey: 'Open a popup layer if a phrase is selected when Ctrl key (also Cmd key on Mac) is pressing',
            ...
            baiduFanyiAPI: 'Baidu Fanyi API',
            baiduFanyiAPIDescriptionHtml: 'Please enter you <a href="http://wordsbaking.com" target="_blank">BaiduFanyi API</a> account below to enable baidu translate feature.',
            baiduFanyiAppID: 'APP ID',
            baiduFanyiAppSecretKey: 'Secret Key',
    ...
    "zh-CN": {
        ...
        wordsbookCloseToLimit: '您的生词本中生词数量就快超出限制了.\n超出限制后, 最早添加的生词将被移出生词本, 但还会保留在 "已学习的单词" 中.',
        wordsbookReachesLimit: '您的生词本中生词数量已经达到限制了.\n超出限制后, 最早添加的生词将被移出生词本, 但还会保留在 "已学习的单词" 中.',
        wordsbookExceedsLimit: '您的生词本中生词数量已经超出限制了.\n最早添加的生词将被移出生词本, 但还会保留在 "已学习的单词" 中.',
        setupAccount: '词焙生词本',
        poweredBy: '由必应强力驱动',
        bingMore: "去必应查看更多",
        synonyms: "近义词",
        ...
        options: {
            ...
            popupSelect: '选择文本时弹出浮层',
            baiduFanyiAPI: '百度翻译API',
            baiduFanyiAPIDescriptionHtml: '请输入您的<a href="http://wordsbaking.com" target="_blank">百度翻译API</a>账号以便使用百度翻译功能',
            baiduFanyiAppID: 'APP ID',
            baiduFanyiAppSecretKey: '密匙',
            account: '词焙账号',
