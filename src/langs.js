var langs = {
    ...
    "zh-CN": {
        ...
        options: {
            ...
            baiduTranslationAPI: '百度翻译API',
            baiduTranslationAPIDescriptionHtml: '请输入您的<a href="http://wordsbaking.com" target="_blank">百度翻译API</a>账号以便使用百度翻译功能',
            baiduTranslationAppID: 'APP ID',
            baiduTranslationAppSecretKey: '密匙',
            account: '词焙账号',
